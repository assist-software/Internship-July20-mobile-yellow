...
public class Constants {
    ...
    public static final int minWorkoutDistance = 10;
    public static final int maxWorkoutDistance = 500000;
    public static final double minWorkoutDuration = 20.41;
    public static final double maxWorkoutDuration = 36000.0;
    public static final int minWorkoutHeartRate = 60;
    public static final int maxWorkoutHeartRate = 240;
    public static final int minWorkoutCalories = 600;
